<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="fv-row mb-7">
            <label class="form-label fw-bolder text-dark fs-6">{{ __('User Name') }}</label>
            <input class="form-control form-control-lg form-control-solid" type="name" name="name" autocomplete="off" value="{{ old('name') }}"/>
        </div>
